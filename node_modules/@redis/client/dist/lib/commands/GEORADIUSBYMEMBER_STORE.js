...
exports.default = {
    ...
    transformArguments(key, from, radius, unit, destination, options) {
        const args = (0, GEORADIUSBYMEMBER_1.transformGeoRadiusByMemberArguments)('GEORADIUSBYMEMBER', key, from, radius, unit, options);

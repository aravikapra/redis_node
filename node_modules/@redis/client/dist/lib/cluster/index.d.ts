...
import { Command, CommandArguments, CommanderConfig, CommandSignature, /*CommandPolicies, CommandWithPoliciesSignature,*/ TypeMapping, RedisArgument, RedisFunctions, RedisModules, RedisScript, RedisScripts, ReplyUnion, RespVersions } from '../RESP/types';
...
export type RedisClusterClientOptions = Omit<RedisClientOptions, keyof ClusterCommander<RedisModules, RedisFunctions, RedisScripts, RespVersions, TypeMapping>>;
...
type ClusterCommand<NAME extends PropertyKey, COMMAND extends Command> = COMMAND['FIRST_KEY_INDEX'] extends undefined ? (COMMAND['IS_FORWARD_COMMAND'] extends true ? NAME : never) : NAME;
...
export default class RedisCluster<M extends RedisModules, F extends RedisFunctions, S extends RedisScripts, RESP extends RespVersions, TYPE_MAPPING extends TypeMapping> extends EventEmitter {
    ...
    executeScript(script: RedisScript, firstKey: RedisArgument | undefined, isReadonly: boolean | undefined, args: Array<RedisArgument>, options?: CommandOptions): Promise<ReplyUnion>;
    /**
     * @internal
     */
    _executePipeline(firstKey: RedisArgument | undefined, isReadonly: boolean | undefined, commands: Array<RedisMultiQueuedCommand>): Promise<unknown[]>;
    /**
     * @internal
     */
    _executeMulti(firstKey: RedisArgument | undefined, isReadonly: boolean | undefined, commands: Array<RedisMultiQueuedCommand>): Promise<unknown[]>;
